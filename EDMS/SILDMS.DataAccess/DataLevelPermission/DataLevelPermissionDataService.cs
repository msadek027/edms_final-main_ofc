    ...
    public class DataLevelPermissionDataService: IDataLevelPermissionDataService
    {
                ...
                else
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        userDataAccesses = dt1.AsEnumerable().Select(reader => new SEC_UserDataAccess
                        {
                            ...
                            AccessTimeLimit = reader.GetDateTime("AccessTimeLimit").ToString("dd/MM/yyyy").Replace('-','/'),
        ...
        public string SetDataLevelPermission(SEC_UserOwnerAccess model, string action, out string errorNumber)
        {
            ...
            try
            {
                ...
                //DateTime.ParseExact("31/03/2016", "yyyy-MM-dd h:mm tt", System.Globalization.CultureInfo.InvariantCulture).ToString();// Convert.ToDateTime(item.CategoryTime); "31/03/2016";
                ...
                if (model.DocCategoryModel != null)
                {
                    foreach (var item in model.DocCategoryModel)
                    {
                        ...
                        if (item.CategoryTime != null)
                            ...
                            objDataRow[1] = DataValidation.DateTimeConversion(item.CategoryTime).ToString();//DataValidation.DateTimeConversion(item.CategoryTime);
                ...
                else if (model.DocTypeModel != null)
                {
                    ...
                    foreach (var item in model.DocTypeModel)
                    {
                        ...
                        if (item.TypeTime != null)
                            objDataRow[1] = DataValidation.DateTimeConversion(item.TypeTime).ToString(); //Convert.ToDateTime(item.TypeTime); 
                        //objDataRow[1] = Convert.ToDateTime(item.TypeTime); 
                ...
                else if (model.DocPropertyModel != null)
                {
                    ...
                    foreach (var item in model.DocPropertyModel)
                    {
                        ...
                        if (item.PropertyTime != null)
                            objDataRow[1] = DataValidation.DateTimeConversion(item.PropertyTime).ToString();// Convert.ToDateTime(item.PropertyTime);
                        ;
                ...
                else if (model.DocPropIdentityModel != null)
                {
                    foreach (var item in model.DocPropIdentityModel)
                    {
                        ...
                        if (item.PropIdentityTime != null)
                            objDataRow[1] = DataValidation.DateTimeConversion(item.PropIdentityTime).ToString();// Convert.ToDateTime(item.PropIdentityTime);
