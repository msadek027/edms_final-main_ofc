        ...
        public string ManipulateUserAccessLog(SEC_UserLog userLogin)
        {
            ...
            try
            {
                ...
                using (DbCommand dbCommandWrapper = db.GetStoredProcCommand("Set_UserActionLogg"))
                {
                    ...
                    db.AddInParameter(dbCommandWrapper, "@LoggID", SqlDbType.NVarChar, userLogin.LoggID);
                    db.AddInParameter(dbCommandWrapper, "@LoggAction", SqlDbType.NVarChar, userLogin.LoggAction);
                    db.AddInParameter(dbCommandWrapper, "@LoggResult", SqlDbType.NVarChar, userLogin.LoggResult);
                    db.AddInParameter(dbCommandWrapper, "@LookupTable", SqlDbType.NVarChar, userLogin.LookupTable);
