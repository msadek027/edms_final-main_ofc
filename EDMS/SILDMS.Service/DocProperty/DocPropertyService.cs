...
namespace SILDMS.Service.DocProperty
{
    public class DocPropertyService :IDocPropertyService
    {
        ...
        #region Constractor
        public DocPropertyService(IDocPropertyDataService repository, ILocalizationService localizationService)
        {
        ...
        public ValidationResult GetInfoValidPeriod(string UserID, string documentID, out DSM_DocProperty obProp)
        {
            obProp = docPropertyDataService.GetInfoValidPeriod(UserID, documentID, out errorNumber);
        ...
        public bool GetMailNotificationStatusForindividualDocProperty(string DocPropertyId)
        {
            ...
            return docPropertyDataService.GetMailNotificationStatusForindividualDocProperty(DocPropertyId);
        }
    }
}
