...
namespace SILDMS.Service.DocProperty
{
    public interface  IDocPropertyService 
    {
        ...
        ValidationResult GetInfoValidPeriod(string UserID, string documentID, out DSM_DocProperty obProp);
        bool GetMailNotificationStatusForindividualDocProperty(string docPropertyId);
    }
}
