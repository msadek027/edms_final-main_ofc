...
namespace SILDMS.Service.Users
{
    public partial interface IUserService
    {
        ...
        IpValidationInfo GetIpValidationInfo(string user, string ip);
        ValidationResult GetAllUserMail(out List<string> mailList);
        ValidationResult GetAUser(string UserID, string OwnerID, out SEC_User obUser);
    }
}
