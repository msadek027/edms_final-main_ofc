...
namespace SILDMS.Web.UI.Areas.SecurityModule.Controllers
{
    public class ServerController : Controller
    {
        ...
        #region Constructor
        public ServerController(IOwnerService ownerService, IOwnerLevelService ownerLevelService, IServerService serverService, ILocalizationService localizationService, ValidationResult respStatus)
        {
        ...
        public async Task<dynamic> AddServer(SEC_Server objServer)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = objServer.ServerID;
                ViewBag.LoggResult = JsonConvert.SerializeObject(objServer); ;
                ViewBag.LoggAction = "Add Server";
                ViewBag.LookupTable = "SEC_Server";
                // Error handling.
