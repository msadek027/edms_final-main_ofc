    ...
    public class UserController : Controller
    {
       ...
       [Authorize]
        ...
        public async Task<dynamic> ChangePassword(string password,string oldPassword)
        {
            ...
            ViewBag.LoggID = UserID;
            ViewBag.LoggResult ="" ;
            ViewBag.LoggAction = "Change Password";
            ViewBag.LookupTable = "SEC_User";

            if (respStatus.ErrorCode != "E404") {
                Session["PasswordReset"] = 100;
            }
        ...
        public async Task<dynamic> AddUser(SEC_User objUser)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = UserID;
                ViewBag.LoggResult = "";
                ViewBag.LoggAction = "Insert User";
                ViewBag.LookupTable = "SEC_User";
                // Error handling.
        ...
        public async Task<dynamic> UpdateUser(SEC_User objUser)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = objUser.UserID;
                ViewBag.LoggResult = "";
                ViewBag.LoggAction = "Edit";
                ViewBag.LookupTable = "SEC_User";
