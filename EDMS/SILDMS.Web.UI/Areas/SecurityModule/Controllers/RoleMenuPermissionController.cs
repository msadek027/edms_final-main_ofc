...
namespace SILDMS.Web.UI.Areas.SecurityModule.Controllers
{
    public class RoleMenuPermissionController : Controller
    {
        ...
        public RoleMenuPermissionController(IRoleSetupService roleService, ILocalizationService localizationService,IRoleMenuPermissionService roleMenuPermissionService, IUserService userService)
        {
        ...
        public async Task<dynamic> SetRoleMenuPermission(SEC_RoleMenuPermission objMenuDetails)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = objMenuDetails.RoleMenuPermissionID;
                ViewBag.LoggResult = JsonConvert.SerializeObject(objMenuDetails); ;
                ViewBag.LoggAction = "Add RoleMenuPermissionID";
                ViewBag.LookupTable = "RoleMenuPermissionID";
