       ...
       //[SILLogAttribute]
        ...
        public async Task<dynamic> EditOwnerLevel(DSM_OwnerLevel obOwnerLevel)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = obOwnerLevel.OwnerLevelID;
                ViewBag.LoggResult = "" ;
                ViewBag.LoggAction = "Insert OwnerLevel";
                ViewBag.LookupTable = "DSM_OwnerLevel";
                return Json(new { Message = respStatus.Message, respStatus }, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        public async Task<dynamic> DeleteOwnerLevel(DSM_OwnerLevel menu)
        {
            ...
            ViewBag.LoggID = menu.OwnerLevelID;
            ViewBag.LoggResult = JsonConvert.SerializeObject(menu).ToString();
            ViewBag.LoggAction = "Delete OwnerLevel";
            ViewBag.LookupTable = "DSM_OwnerLevel";
            return Json(new { Message = respStatus.Message, respStatus }, JsonRequestBehavior.AllowGet);
        }
