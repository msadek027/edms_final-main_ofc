...
namespace SILDMS.Web.UI.Areas.DocScanningModule.Controllers
{
    public class DocDestroyController : Controller
    {
        ...
        public DocDestroyController(IDocDestroyPolicyService destroyPolicyService, IDocDestroyService docDestroyService, IOwnerProperIdentityService ownerProperIdentityRepository, 
            IDocCategoryService docCategoryService, IDocTypeService docTypeService, IDocPropertyService docPropertyService, ILocalizationService localizationService)
        {
        ...
        public async Task<dynamic> GetDestroyDetailsBySearchParam(string _OwnerID, string _DestroyID, string _DocCategoryID, string _DocTypeID, string _DocPropertyID, string _DocPropIdentityID)
        {
            List<DSM_DestroyPolicy> destroyPolicies = null;

            await Task.Run(() => _docDestroyService.GetDestroyDetailsBySearchParam(_DestroyID, UserID, _OwnerID, _DocCategoryID, _DocTypeID, _DocPropertyID, _DocPropIdentityID, out destroyPolicies));
        ...
        public async Task<dynamic> GetDocCategoriesForSpecificUser(string _DestroyPolicyID, string _OwnerID, string _DestroyID)
        {
            ...
            await Task.Run(() => _destroyPolicyService.GetDestroyPolicyBySearchParam(null, UserID, _OwnerID, null, null, null, null, out dsmDestroyPolicies));

            await Task.Run(() => _docDestroyService.GetDestroyDetailsBySearchParam(_DestroyID, UserID, _OwnerID, null, null, null, null, out dsmDestroy));
            ...
            string _OwnerID, string _DocCategoryID, string _DestroyID)
        {
            ...
            await Task.Run(() => _destroyPolicyService.GetDestroyPolicyBySearchParam(null, UserID, _OwnerID, _DocCategoryID, null, null, null, out dsmDestroyPolicies));
            await Task.Run(() => _docDestroyService.GetDestroyDetailsBySearchParam(_DestroyID, UserID, _OwnerID, null, null, null, null, out dsmDestroy));

            if (_DestroyID == "")
            {
                var result = (from dc in dsmDestroyPolicies
                              where dc.PolicyDetailStatus == 1 & dc.DocPropertyID == "" & dc.OwnerID == _OwnerID & dc.DocCategoryID == _DocCategoryID
            ...
            string _DocTypeID, string _DestroyID)
        {
            ...
            await Task.Run(() => _destroyPolicyService.GetDestroyPolicyBySearchParam(null, UserID, _OwnerID, _DocCategoryID, _DocTypeID, null, null, out dsmDestroyPolicies));
            await Task.Run(() => _docDestroyService.GetDestroyDetailsBySearchParam(_DestroyID, UserID, _OwnerID, null, null, null, null, out dsmDestroy));

            if (_DestroyID == "")
            {
                var result = (from dc in dsmDestroyPolicies
                              where dc.PolicyDetailStatus == 1 & dc.DocPropIdentifyID == "" & dc.OwnerID == _OwnerID & dc.DocCategoryID == _DocCategoryID & dc.DocTypeID == _DocTypeID
            ...
            string _DocTypeID, string _DocPropertyID, string _DestroyID)
        {
            ...
            await Task.Run(() => _destroyPolicyService.GetDestroyPolicyBySearchParam(null, UserID, _OwnerID, _DocCategoryID, _DocTypeID, _DocPropertyID, null, out dsmDestroyPolicies));
            await Task.Run(() => _docDestroyService.GetDestroyDetailsBySearchParam(_DestroyID, UserID, _OwnerID, null, null, null, null, out dsmDestroy));

            if (_DestroyID == "")
            {
                var result = (from dc in dsmDestroyPolicies
                              where dc.PolicyDetailStatus == 1 & dc.OwnerID == _OwnerID & dc.DocCategoryID == _DocCategoryID & dc.DocTypeID == _DocTypeID & dc.DocPropertyID == _DocPropertyID
        ...
        public async Task<dynamic> SetDocDestroy(DSM_DestroyPolicy model)
        {
            if (ModelState.IsValid)
            {
                ...
                ViewBag.LoggID = model.DestroyPolicyID;
                ViewBag.LoggResult = "";
                ViewBag.LoggAction = "Insert";
                ViewBag.LookupTable = "DSM_DestroyPolicy";
